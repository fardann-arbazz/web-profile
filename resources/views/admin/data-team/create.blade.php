        ...
        <div class="row page-titles mx-0">
            <div class="col p-md-0">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="javascript:void(0)">Create Data Team</a></li>
                </ol>
            </div>
        </div>
        <!-- row -->
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-validation">
                                <form class="form-valide" action="{{ route('store.team') }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-lg-4 col-form-label" for="val-username">Name <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-lg-6">
                                            <input type="text" name="name" class="form-control" id="val-username" placeholder="Massukkan judul..">
                                            @error('name')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-6">
                                            <input type="text" name="position" class="form-control" id="val-username" placeholder="Massukkan judul..">
                                            @error('position')
                                               <div class="alert alert-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
